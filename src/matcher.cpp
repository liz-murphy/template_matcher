...
#include <template_matcher/matcher.h>
#include <template_matcher/Match.h>
#include "cv.h"
...
void Matcher::processImageCB(const sensor_msgs::ImageConstPtr& image_msg)
{
    total_frames_++;
...
double Matcher::compareFrame(MatrixTPlate &current_template, int &xoffset, int &yoffset, int &best_match_id, std::vector<score_record> &match_scores) {
...
int main(int argc, char **argv)
{
    ...
    Matcher *sk_match = new Matcher(image_topic, match_topic, max_templates, match_threshold, acceptable_match_threshold, rstep, max_matches, window);
