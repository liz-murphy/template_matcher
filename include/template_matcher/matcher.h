...
public:
    ...
    Matcher(string image_topic, string match_topic, int max_templates, double match_threshold, double acceptable_match_threshold, int rstep, int max_matches, int window);
